...
Our usage in this class will be fairly pedestrian, but you can do some really complex things, like writing entire manuscripts using the [bookdown](https://bookdown.org/yihui/bookdown/) package, make a [CV](https://cran.r-project.org/web/packages/vitae/index.html), or generate a [website](https://bookdown.org/yihui/blogdown/). Read more about [R Markdown]( http://rmarkdown.rstudio.com/).
...
Choose Choose names for each of these vectors. Add your code to the block below.
 for these vectors. Add your code to the block below.
...
If you use `data.frame()`, include the argument `stringsAsFactors = FALSE` to tell R not to convert the strings to factors.
...
M2 <- tibble(ID=seq(1,100),x=rnorm(100,10,5),y=8.4*x+rnorm(100))
```
