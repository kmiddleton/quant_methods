...
pos.counts <- data.frame('counts' = apply(allP, 2, function(x) sum(x< th)))
...
Now use this same procedue to calculate the false positive rate, FWER, and false discovery rate at the range of thresholds given below. Store your output (including the threshold) in a `data.frame`.
