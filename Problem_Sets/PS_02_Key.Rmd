...
<!-- REMOVED THE TIDYVERSE OPTION THERE BC THEY DON'T LEARN IT TILL WEEK 3 -->
...
4. Rows 1-50 (either using base R or the `slice()` function from tidyverse)
...
<!-- DO WE WANT THEM TO GOOGLE THIS MUTATE()?  NOT IN LECTURES -->
