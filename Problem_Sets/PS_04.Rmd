...
Now create a new plot consisting of a density plot for #3 and #6 above on a single plot. First create a single data frame with both sets and a column identifying each group.
