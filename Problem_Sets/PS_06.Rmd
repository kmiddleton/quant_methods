...
```{r}
# Function to calculate sum of squares of a vector
...
Is it correct to say that there is a 95% probabiliity that the true mean is within a 95% confidence interval? Why or why not? Think about what you just showed with your simulation.
...
The data we gave you here is a proportion. What is anoter format that the data could have been in? Think about the source of the portion values.
