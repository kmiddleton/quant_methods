...
What is the probability that randomly tested person over 65 has prostate cancer, given that they have received a positive PSA test? Solve this problem however you would like.
...
#### Using an arbitrary number of tests

Assume that you carry out 1,000 tests. Note that is doesn't matter that there are "partial"positive tests (i.e., 67.2 below). The calculations work just fine.

- Total with cancer: 1000 $\times$ 0.04 = 40
- Total with no cancer: 1000 $\times$ (1 − 0.04) = 960
