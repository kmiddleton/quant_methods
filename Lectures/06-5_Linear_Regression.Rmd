...
For a range of $\theta_1$ from -10 to 10 in increments of 0.01, calculate the log-likelihood of the model. Save to a variable called `lls`. Then find the maximum value of `lls`, the associated $\theta_0$ and log-likelihood.
...
plot(lls ~ theta_1,
     ...
     xlab = "Slope",
     ylab = "log-Likelihood")
points(theta_1_hat, max.ll, col = "red", pch = 16, cex = 1.5)
text(-10, -60, paste("theta_1 =", theta_1_hat, "\nlogLik =", round(max.ll, 2)),
     pos = 4, cex = 2)
```
