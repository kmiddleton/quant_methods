...
- Burnham and Anderson [-@Burnham2001-wq] Kullback-Leibler information as a basis for strong inference in ecological studies. *Wildl Res* 28:111-119.

## Additional resources

- Anderson and Burnham [-@Anderson2002-cf]. Avoiding Pitfalls When Using Information-Theoretic Methods. *J Wildl Manage* 66:912–918.
- Burnham & Anderson [-@Burnham2004-zr]. Multimodel Inference: Understanding AIC and BIC in Model Selection. *Sociol Methods Res* 33:261–304.
- Burnham and Anderson [-@Burnham2002-xt]. *Model Selection and Multi-model Inference: a Practical Information Theoretic Approach*. Springer
- Judge et al. [-@Judge1985-gl]: *The Classical Inference Approach for the General Linear Model*. John Wiley & Sons
...
<center>
<img src="images/ockham.jpg" width="80%" />
</center>
...
**Overfitting**: Model is too accurate. Describes the sample *too well*.

- Leads to poor prediction

We need to find a balance between *regular* and *irregular* features.
...
- Are the estimates large enough to be used for prediction?
...
## Brain volume and (estimated) body mass in hominins
