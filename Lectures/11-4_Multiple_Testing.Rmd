...
3. Sequential Bonferroni procedure
4. False Discovery Rate
5. _Positive_ False Discovery Rate
...
1. <s>Do nothing</s>
2. <s>Bonferroni correction</s> (excessively conservative, and we can do better)
3. Sequential Bonferroni procedure
