...
Bolker et al. [-@bolker_generalized_2009]: Generalized linear mixed models: a practical guide for ecology and evolution

## Additional resources {.smaller}

*Approachable*:

- Zuur et al. [-@zuur_mixed_2009a]: *Mixed Effects Models and Extensions in Ecology with R*. But takes a very old fashioned view of model selection.

*Bayesian*:

- McElreath [-@mcelreath_statistical_2015]: *Statistical Rethinking: A Bayesian Course with Examples in R and Stan*

*MCMC*:

- Hadfield [-@hadfield_mcmc_2010]: MCMC Methods for Multi-response Generalized Linear Mixed Models: The MCMCglmm R Package

*Technical*:

- Pinheiro and Bates [-@pinheiro_mixed-effects_2000]: *Mixed-effects models in S and S-PLUS*
...
- Phylogenetic structure [@paradis_analysis_2012; @paradis_analysis_2002]
- Genetic structure and pedigrees [@wilson_ecologist_2010]
...
<center>
<img src="images/WCB/WCB_img.003.png" width="90%" />
</center>
...
<center>
<img src="images/WCB/WCB_img.006.png" width="70%" />
</center>

## Turning flight in hummingbirds

<center>
<img src="images/WCB/WCB_img.007.png" width="70%" />
</center>
...
<center>
<img src="images/WCB/WCB_img.011.png" width="100%" />
</center>
...
<center>
<img src="images/WCB/WCB_img.013.png" width="90%" />
</center>

## Turning flight in hummingbirds

<center>
<img src="images/WCB/WCB_img.014.png" width="90%" />
</center>
...
Note: very close but not numerically equivalent to the `aov()` version. *Models are slightly different*.
...
Refit the original model with `gls()`. Without `weights`, this equals `lm()`. This will allow us to use `anova()`.
...
Weighted model fits significantly better.

## Visualization of the preferred model
...
- No likelihood ratio tests here.
- We will cover AIC and model comparison Friday.
- For now
    - The multilevel models are preferred much more preferred.
    - We will compare those models on Friday
...
Adapted from McElreath [-@mcelreath_statistical_2015]
