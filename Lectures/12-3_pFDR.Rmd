...
$$\mbox{FDR} = \frac{\mbox{n False Positives}}{\mbox{n Rejected Hypotheses}}$$
...
4. Sequential Bonferroni procedure
5. False Discovery Rate
    - More permissive than Bonferroni or sequential Bonferroni, but controls a different quantity
6. _Positive_ False Discovery Rate
