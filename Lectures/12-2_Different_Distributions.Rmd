...
<center>
<img src="https://i.imgur.com/E2Gu7ke.png" width="100%" />
</center>
...
```{r}
M2 <- M %>% group_by(season, month, area) %>%
              summarize(number_sole = sum(as.numeric(Solea_solea)),
...
```{r}
fm2 <- glm(number_sole ~ avg_salinity, data = M2, family = "poisson")
```


## Number of sole{.smaller}
...
<center>
<img src="https://i.imgur.com/a4DpQbL.png" width="70%" />
</center>
