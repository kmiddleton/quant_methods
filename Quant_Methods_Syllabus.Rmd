...
You will get as much or as little from this course as you put into it. Assignments are graded only for completion. You should go through your own answers along with the provided answer key to check and compare. There are many equally correct ways to do many things in R. Your method may differ, but the results should not. Our provided solution methods are just our preferred way.

This course will require you to watch lecture videos outside of class and answer questions related to those videos through Canvas (these questions help guide what we cover in-erpson). Treat these online lectures as you would a regular, in-person lecture:
...
We expect you to be an active participant in class. If you do not understand something, it is your responsibility to ask. Being a silent attendee will not benefit you, and your instructors will not know if you do not understand until it is too late. We will provide a way to anonymously ask questions.
...
1. Quiz questions (completion, not correctness)
1. Problem sets 
...
All course material, announcements, and instructions will be available on the course Canvas site. We assume you will check Canvas regularly. After the initial course emails, we will only communicate with you via Canvas messaging. Please make sure you have checked your notification settings to ensure you receive these messages. You may communicate with us via Canvas messaging or by emailing our university email addresses. 
